...
approximately 1 millisecond small practical tests/experiments with
\texttt{monitor} (see \footcite{yahdzhyiev2025repo} \path{code/src/monitor.c})
and \texttt{profile} (see \footcite{yahdzhyiev2025repo} \path{code/src/profile.c})
showed the possibility of obtaining distinct energy readings from
\gls{PM} Table on much higher rates (approx. 1 micro-second)
